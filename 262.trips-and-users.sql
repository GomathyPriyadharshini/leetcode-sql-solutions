...
-- "2013-10-01" and "2013-10-03" with at least one trip. Round Cancellation
-- Rate to two decimal points.
-- 
...
select request_at as Day,round(sum(case when status !='completed' then 1 else 0 end) / count(*),2) as "Cancellation Rate" from
trips a 
