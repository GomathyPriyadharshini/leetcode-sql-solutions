...
-- User 5 purchased products from Books (102, 103) and Clothing (201,
-- 202)
...
-- User 2 purchased products from Books (102, 103) and Electronics
-- (101)
...
-- 
-- 
-- Other category pairs like Clothing-Sports (only 2 customers: Users 1 and 4)
-- and Books-Kitchen (only 1 customer: User 3) have fewer than 3 shared
-- customers and are not included in the result.
-- 
-- 
-- The result is ordered by customer_count in descending order. Since all pairs
-- have the same customer_count of 3, they are ordered by category1 (then
-- category2) in ascending order.
-- 
-- SQL QEURY

with user_categories as 
(select user_id,category from productpurchases t1
inner join productinfo t2
