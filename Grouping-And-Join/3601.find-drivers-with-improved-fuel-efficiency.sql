...
-- Each row represents a trip made by a driver, including the distance traveled
-- and fuel consumed for that trip.
-- 
-- 
-- Write a solution to find drivers whose fuel efficiency has improved by
-- comparing their average fuel efficiency in the first half of the year with
...
-- 
-- 
-- First half trips (Jan-Jun): Feb 15 (120.5/10.2 = 11.81), Mar 20 (200.0/16.5
-- = 12.12)
-- First half average efficiency: (11.81 + 12.12) / 2 = 11.97
-- Second half trips (Jul-Dec): Aug 10 (150.0/11.0 = 13.64), Sep 25 (180.0/12.5
-- = 14.40)
...
-- David Wilson (driver_id = 4): Only has trips in second half (Jul,
-- Nov)
...
select t1.driver_id,driver_name,round(first_half_avg,2) as first_half_avg,round(second_half_avg,2) as second_half_avg,round((second_half_avg - first_half_avg),2) as efficiency_improvement from first_half t1
inner join second_half t2
on t1.driver_id=t2.driver_id
inner join drivers t3
