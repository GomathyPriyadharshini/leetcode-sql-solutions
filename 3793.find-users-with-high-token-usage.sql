--
-- @lc app=leetcode id=3793 lang=mysql
--
...
-- Each row represents a prompt submitted by a user to an AI system along with
...
-- 
-- 
-- Return the result table ordered by average tokens in descending order, and
...
select t1.user_id,prompt_count,avg_tokens from cte t1
where exists
(select 1 from 
prompts t2
where  t1.user_id=t2.user_id
and t1.avg_tokens<t2.tokens)
and prompt_count>=3
