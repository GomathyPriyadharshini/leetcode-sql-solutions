...
-- Each row contains a DNA sequence represented as a string of characters (A,
-- T, G, C) and the species it was collected from.
-- 
-- 
...
-- For each pattern, 1 indicates the pattern is present and 0 indicates it is
-- not present
-- 
-- 
-- 
...
case when REGEXP_LIKE(dna_sequence,'G{3,}','c') then 1 else 0 end as has_ggg
from samples
